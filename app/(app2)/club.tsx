/**
 * CLUB — porte communauté (app2). Placeholder du lot L0 (Livrable 8),
 * remplacé par le lot L4. Entrée d'écran : la porte (useDoorTransition).
 */
...
export default function ClubDoor() {
  ...
  return (
    ...
    >
      ...
      <StateView
        state="empty"
        emptyMessage="À venir — la vie du club s'installera ici."
        style={styles.state}
      />
    </Animated.View>
  );
