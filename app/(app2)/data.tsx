/**
 * DATA — porte analyse (app2). Placeholder du lot L0 (Livrable 8),
 * remplacé par le lot L2. Entrée d'écran : la porte (useDoorTransition).
 */
...
export default function DataDoor() {
  ...
  return (
    ...
    >
      ...
      <StateView
        state="empty"
        emptyMessage="À venir — vos données de roulage s'installeront ici."
        style={styles.state}
      />
    </Animated.View>
  );
