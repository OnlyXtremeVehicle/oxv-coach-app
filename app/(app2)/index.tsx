/**
 * MIROIR — porte d'accueil (app2). Placeholder du lot L0 (Livrable 8),
 * remplacé par le lot L1. Entrée d'écran : la porte (useDoorTransition).
 */
...
export default function MiroirDoor() {
  ...
  return (
    ...
    >
      ...
      <StateView
        state="empty"
        emptyMessage="À venir — votre lecture de séance s'installera ici."
        style={styles.state}
      />
    </Animated.View>
  );
