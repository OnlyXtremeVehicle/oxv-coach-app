/**
 * REC — cible du bouton central (app2). Placeholder du lot L0 (Livrable 8),
 * remplacé par le flux capture V2 (lot L2-B). Entrée d'écran : la porte.
 */
...
export default function RecDoor() {
  ...
  return (
    ...
    >
      <Text style={styles.title}>REC</Text>
      <StateView
        state="empty"
        emptyMessage="À venir — la capture de vos séances s'installera ici."
        style={styles.state}
      />
    </Animated.View>
  );
