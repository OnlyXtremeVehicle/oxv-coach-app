/**
 * Pass OXV — la journée d'événement côté pilote (PR-27, sans QR).
 *
 * Affiche les inscriptions du pilote (ses « passes ») avec le contexte logistique
 * (lieu, horaires, briefing, statut), et les événements ouverts à l'inscription.
 * Le QR de check-in viendra avec la dépendance dédiée ; le check-in admin manuel
 * fonctionne déjà. Pour annuler une inscription, passer par le support.
 *
 * Doctrine : sobre, vouvoiement, pas d'emoji, or = donnée (statuts neutres).
 */
    ...
    <Screen>
      ...
      <View style={{ paddingHorizontal: theme.spacing.lg, paddingBottom: theme.spacing.xxl }}>
        ...
        <Text style={s.footnote}>
          Le code de présence arrivera bientôt. Pour annuler une inscription, écrivez-nous depuis le
          support.
        </Text>
      </View>
    </Screen>
