...
> (« Le Sillage qui s'ancre » : moteur _Fait Élu_ sans badge I→IV → présentation _Sillage_ maintenant →
> _Tour Tracé_ ancré post-capture). **Phase S livrée et vérifiée** dans [`bilan.tsx`](<../app/(app)/bilan.tsx>) :
...
### 1. Le Fait Élu _(élection algorithmique)_
...
### 2. Le Tour Tracé _(le fait ancré sur la géographie)_
...
### 3. Face-à-Face _(diptyque soi-contre-soi)_
...
### 4. La Dépêche _(éditorial typographique)_
...
### 5. Le Sillage _(un fait qui porte son temps)_ — **recommandé**
...
**Convergence** : _le Sillage est le seul à franchir les deux portes éliminatoires_ — conformité **et**
...
## Recommandation — « Le Sillage qui s'ancre » _(hybride, à deux étages)_
...
- **Tour Tracé** _(différé, post-Valence)_ → le mini-tracé/faisceau dans la zone situation.
- **Fait Élu** _(très différé, sous validation)_ → l'idée d'élection par profondeur, **sans** le badge I→IV ni « pourquoi ce fait » tant que la doctrine n'est pas tranchée.
