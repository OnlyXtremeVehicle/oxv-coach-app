...
conduite. _Miroir, pas coach_ : décrit, ne prescrit jamais. Sécurité > perf,
...
remplacer le miroir**. La voix du coach apparaît côté pilote _attribuée_ (bande rouge).
...
_Nombres de fonctionnalités relevées : pilote 53 · coach 25 · partenaire 9 · admin 22._
