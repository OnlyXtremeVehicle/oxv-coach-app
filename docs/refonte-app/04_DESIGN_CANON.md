...
- **Instrument Serif** (regular + italic) — _à ajouter_ : touches éditoriales — grands titres d'écran (« Bonsoir. », « Prêt à rouler. »), le mot qualitatif du bilan en italique (« Terrain apprivoisé »), citations du coach, dates hero (« 05 »). **Jamais** pour les chiffres d'instrument.
