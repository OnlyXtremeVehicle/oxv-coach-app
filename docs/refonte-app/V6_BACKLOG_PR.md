...
_But : verrouiller la doctrine au runtime (filtre IA branché partout), fermer les trous
RGPD/sécurité, livrer les écrans P1 indispensables. Zéro schéma sauf tables support._
...
_But : livrer le concept **ÉVÉNEMENT** (table pivot → Pass OXV, leads/offres liés, B2B
Report, control-tower admin), compléter partenaire + pilote, durcir transparence IA et
honnêteté. Gros STOP : `events` + `event_registrations`._
...
_But : Coach AI sous filtre dur, programmes adaptatifs, Data Confidence / Key Moments,
espace Pilote Pro complet, médias, performance partenaire. Forte densité de STOP-schéma._
