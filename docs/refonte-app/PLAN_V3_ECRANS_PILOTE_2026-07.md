...
## Zone Data Lab _(vague en cours)_
...
## Zone Carnet _(volontairement sans donnée/couleur QDI)_
...
_(NB : `progression` et `regularite` annoncés mais **faux positifs** — vérifiés propres.)_
