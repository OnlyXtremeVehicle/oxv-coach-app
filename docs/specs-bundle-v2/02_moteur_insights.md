...
## E. Profondeur 3 — Faits spatiaux revele sur le trace _(differenciant)_
...
### 3.1 — Dispersion de trajectoire par virage _(phare)_
...
### 3.2 — Tour de reference compose _(phare)_
...
## F. Profondeur 4 — Correlations observees _(le sommet du miroir)_
...
### 4.1 — Coherence du flow _(phare)_
...
## G. Profondeur 5 — Lecture du coach _(hors moteur OXV — espace `CoachBand`)_
