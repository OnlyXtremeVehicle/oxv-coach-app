...
//   - Lien de téléchargement de l'app OXV Coach (TestFlight / Play)
...
<head>
  <meta charset="utf-8">
  <title>Bienvenue chez OXV Coach</title>
</head>
<body style="margin: 0; padding: 40px 20px; background: #050505; font-family: 'Helvetica Neue', Arial, sans-serif;">
  <table cellpadding="0" cellspacing="0" border="0" align="center" style="max-width: 560px; margin: 0 auto; background: #0a0a0a; border: 1px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 40px;">
    <tr><td>
      <p style="margin: 0 0 24px 0; color: #1E3A5F; font-size: 11px; letter-spacing: 3px; font-weight: 600;">OXV COACH · INVITATION</p>
      <h1 style="margin: 0 0 24px 0; color: #ffffff; font-size: 28px; font-weight: 200; line-height: 1.3;">Bonjour ${fullName}.</h1>
      <p style="margin: 0 0 16px 0; color: #cccccc; font-size: 16px; line-height: 1.6;">L'équipe OXV vous invite à rejoindre l'application OXV Coach en tant que coach.</p>
      ...
      <ol style="margin: 0; padding-left: 20px; color: #cccccc; font-size: 14px; line-height: 1.8;">
        <li>Installez l'application OXV Coach&nbsp;:
...
L'équipe OXV vous invite à rejoindre l'application OXV Coach en tant que coach.
...
Pour commencer :
1. Installez OXV Coach (iPhone : https://apps.apple.com/app/oxv, Android : https://play.google.com/store/apps/details?id=fr.oxvehicle.app)
...
— L'équipe OXV`;
    ...
    const resendBody = {
      ...
      to: [email],
      subject: 'Bienvenue chez OXV Coach',
      html,
      text,
