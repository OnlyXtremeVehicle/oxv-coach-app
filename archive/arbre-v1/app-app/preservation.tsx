/**
 * Écran #11 — Vos données sont en sécurité. (route `/preservation`)
 *
 * Déplacé depuis `donnees-securite.tsx` (2026-07-13) : la route
 * `/donnees-securite` porte désormais l'écran RGPD « Données & sécurité »
 * de la zone Compte (maquette refonte-v2 §7bis #9c). Cet écran-ci reste
 * l'étape du FLUX CAPTURE entre « Pilotage fini » et « Bilan prêt ».
 *
...
export default function PreservationScreen() {
